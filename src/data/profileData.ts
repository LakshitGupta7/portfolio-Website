  ...
  career: [
    {
      ...
      year: "2024",
      description: "Processed and analyzed 500+ real world MRIs and CT scans to train AI models for brain stroke detection."
    }
  ],
  projects: [
    {
      title: "Autonomus Drone Detection System",
      category: "Computer Vision",
      tools: "Python, OpenCV, YOLO, ResNet50",
      description: "A system for autonomous detection of drones using computer vision techniques like YOLO and ResNet50."
    },
    {
      title: "Drone Audio Detection System",
      category: "Audio Processing",
      tools: "Python, OpenCV, Yamnet",
      description: "An audio-based detection system specifically for drones, leveraging Yamnet for audio classification."
    },
    {
      title: "Portfolio",
